            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                        ...
                        <div class="form-group w-50 d-flex flex-column">
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="input-group">
                                    <input type="datetime-local" class="form-control" name="date" id="date" value="{{$game->date}}">
                                </div>
                            </div>
                            @error('date')
                        ...
                        <div class="form-group mt-3">
                            <input type="submit" class="btn btn-warning" value="Играть">
                        </div>
                        <div class="mr-4">
